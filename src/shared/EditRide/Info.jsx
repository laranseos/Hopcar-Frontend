...
import '../../pages/shake.css'
 ...
 const [error, setError] = useState(null);
  ...
  const handleSubmitClick = (e) => {
    ...
    navigate('/edit/publishalert',{state:ride})
    }
  };
      ...
      <>
        <div className='text-center w-full'>
            <form onSubmit={handleSubmitClick}>
               ...
               <br></br>
               <button type='submit' className='mt-16 bg-green-400 text-white font-bold rounded-full h-12 w-28 hover:bg-green-500'>Update Ride</button>
            </form>
        </div>
      </>
   )
