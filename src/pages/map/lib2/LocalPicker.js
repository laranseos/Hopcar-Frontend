...
class LocalPicker extends React.Component {
  ...
  handleButtonClick = (event) => {
    const inputValue = document.getElementById('arrival').value;
    if (inputValue === "") {
      ...
      localStorage.setItem('pos2', JSON.stringify(inputValue));
    ...
    return (
      <div className='flex mt-0 mb-0'>
        <div className='w-1/2 text-center'>
            ...
            <br></br>
            <Link to="/ride/ride"><button type='submit' onClick={this.handleButtonClick} className='mt-16 bg-green-400 text-white font-bold rounded-full h-12 w-28 hover:bg-green-500'>Continue</button></Link>
        </div>
